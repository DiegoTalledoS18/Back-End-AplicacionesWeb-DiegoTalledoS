...
namespace LearningCenter.Infraestructure.Migrations
{
    ...
    [Migration("20221025182927_CategoryParameter")]
    partial class CategoryParameter
    {
            ...
            modelBuilder.Entity("LearningCenter.Infraestructure.Category", b =>
                {
                    ...
                    b.Property<DateTime>("DateCreated")
                        ...
                        .HasDefaultValue(new DateTime(2022, 10, 25, 13, 29, 27, 7, DateTimeKind.Local).AddTicks(4472));
            ...
            modelBuilder.Entity("LearningCenter.Infraestructure.Tutorial", b =>
                {
                    ...
                    b.Property<DateTime>("DateCreated")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime(6)")
                        .HasDefaultValue(new DateTime(2022, 10, 25, 13, 29, 27, 7, DateTimeKind.Local).AddTicks(5221));
            ...
            modelBuilder.Entity("LearningCenter.Infraestructure.User", b =>
                {
                    ...
                    b.Property<DateTime>("DateCreated")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime(6)")
                        .HasDefaultValue(new DateTime(2022, 10, 25, 13, 29, 27, 7, DateTimeKind.Local).AddTicks(5860));
