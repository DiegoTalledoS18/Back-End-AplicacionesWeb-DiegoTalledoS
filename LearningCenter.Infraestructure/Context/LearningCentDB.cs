...
public class LearningCentDB:DbContext//Esta clase hace referencia a la base de datos
{
    ...
    protected override void OnModelCreating(ModelBuilder builder)
    {
        ...
        builder.Entity<Tutorial>().Property(c => c.Year).IsRequired();

        builder.Entity<Tutorial>().Property(c => c.Categoryid).IsRequired();

        builder.Entity<Tutorial>().Property(c => c.Category).IsRequired();
